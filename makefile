...
O_FILES:= main.o Battery.o House.o OurSensor.o Point.o Robot.o Score.o SimpleIniFileParser.o Simulator.o FuncForMain.o Table.o SharedAlgorithm.o
...
SharedAlgorithm.o: SharedAlgorithm.cpp SharedAlgorithm.h AbstractAlgorithm.h AbstractSensor.h OurSensor.h
	g++ -c $(CFLAGS) $*.cpp
